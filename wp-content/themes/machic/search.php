...
<div class="klb-blog page-content">
	<div class="container">
		...
		<h2 class="search-title"><?php printf( esc_html__( 'Search Results for: %s', 'machic' ), get_search_query() ); ?></h2>

		<?php if( get_theme_mod( 'machic_blog_layout' ) == 'left-sidebar') { ?>
				...
				<div class="col col-12 col-md-9 col-lg-9 content-primary">
					<div class="blog-posts">
						...
						<?php else : ?>
							...
							<h2 class="no-post"><?php esc_html_e('No Posts Found', 'machic') ?></h2>
		...
		<?php } elseif( get_theme_mod( 'machic_blog_layout' ) == 'full-width') { ?>
