...
class Machic_Category_Banner2_Widget extends Widget_Base {
	...
	protected function render() {
		...
		$catlink = !empty($settings['cat_filter']) ? get_term_link( intval(implode(' ',$settings['cat_filter'])), 'product_cat' ) : '';
		$term = !empty($settings['cat_filter']) ? get_term( implode(' ',$settings['cat_filter']), 'product_cat' ) : '';
